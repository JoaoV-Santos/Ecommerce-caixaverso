        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    ...
                    Long idCliente = sc.nextLong(); sc.nextLine();
                    ...
                    cliente = new Cliente(idCliente, nome, email, cpf);
                ...
                case 3:
                    ...
                    Long idCliPedido = sc.nextLong();
                    sc.nextLine();

                    Optional<Cliente> optCliente = clienteService.buscarPorId(idCliPedido);
